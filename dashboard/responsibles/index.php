...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_p']),"Responsibles",$_SESSION['refroll_p'],'');


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Responsible";

$plural = "Responsibles";

$eliminar = "eliminarResponsible";

$insertar = "insertarResponsible";
...
$lblCambio	 	= array("responsible");
$lblreemplazo	= array("responsible");
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosProyects->traerResponsible(),1);
