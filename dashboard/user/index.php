...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_p']),"User",$_SESSION['refroll_p'],'');
...
$lblCambio	 	= array("fullname","refroll");
$lblreemplazo	= array("Full Name","Rol");


$resRol 	= $serviciosProyects->traerRoles();
$cadRef = '';
while ($rowTT = mysql_fetch_array($resRol)) {
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosProyects->traerUser(),5);
    ...
    <div class="boxInfoLargo">
    	...
    	<div class="cuerpoBox">
            ...
            <div class="alert alert-info" style="margin-left:15px; margin-right:15px;">
            	<p><span class="glyphicon glyphicon-info-sign"></span> The User, Email, Password and Full Name fields are mandatory</p>
            </div>
            <div class="alert alert-warning" style="margin-left:15px; margin-right:15px;">
            	<p><span class="glyphicon glyphicon-info-sign"></span> With the Email and Password field enter the system</p>
            </div>
