...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_p']),"Employees",$_SESSION['refroll_p'],'');
...
$lblCambio	 	= array("lastname","firstname");
$lblreemplazo	= array("Last Name","First Name");
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosProyects->traerEmployee(),3);
